...
// Original HTML select for backward compatibility
const HTMLSelect = React.forwardRef<HTMLSelectElement, React.SelectHTMLAttributes<HTMLSelectElement>>(
...
HTMLSelect.displayName = "Select"

// Original SelectOption for backward compatibility
...
// Export both the original HTML select components and the Radix UI components
export {
  Select,
  HTMLSelect,
  SelectOption,
